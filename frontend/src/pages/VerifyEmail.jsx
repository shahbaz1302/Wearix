      ...
      >
        ...
        <form onSubmit={handleSubmit} className='text-center space-y-6'>
          <div className='flex justify-between'>
            {code.map((digit, index) => (
              <input
                ...
                className='w-12 h-12 text-center text-2xl font-bold  --text-color border-2 border-gray-600 rounded-lg focus:border-green-500 focus:outline-none'
              />
            ))}
          </div>
          ...
          <button
            ...
            className={`${theme === "dark" ? "bg-white text-black" : "bg-black text-white"} px-8 py-2 font-light mt-4 cursor-pointer rounded-sm transition-colors duration-350`}
          >
